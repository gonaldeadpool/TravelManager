    ...
    <div class="p-6">
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <form method="GET" class="mb-4 flex gap-2">
                ...
                <input id="ricerca-clienti" type="search" name="ricerca" value="{{ $ricerca }}" placeholder="Cerca per nome, cognome o email" class="w-full rounded border px-3 py-2 md:max-w-md">
                <button class="rounded border px-4 py-2 text-gray-700">Cerca</button>
            </form>

            <form method="POST" action="{{ route('pratiche.clienti.store', $pratica) }}">
                @csrf
                ...
                <div class="mt-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <button class="rounded bg-blue-600 px-4 py-2 text-white">Aggiungi clienti selezionati</button>
                </div>
            </form>
        </div>
    </div>
